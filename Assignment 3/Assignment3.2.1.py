...
for predators in range(1,5):#range(1,5)[::-1]:
    ...
    for i in range(runs):
        steps, rewards = Qlearning(episodes, predatorLocations[:predators], epsGreedyPolicy,alpha_pred=0.2,alpha_prey=0.2)
...
pl.ylim(0,1)
pl.savefig("plots/equalratio321.png")
pl.close()
...
# Put a legend to the right of the current axis
ax.legend(labels,loc='center left', bbox_to_anchor=(1, 0.5))
pl.savefig("plots/equalsteps321.png")
...
pl.savefig("plots/equalstepscatch321.png")
...
# Put a legend to the right of the current axis
ax.legend(labels[1:],loc='center left', bbox_to_anchor=(1, 0.5))
pl.savefig("plots/equalstepscrash321.png")