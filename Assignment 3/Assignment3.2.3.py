...
for predators in range(1,5):#range(1,5)[::-1]:
    ...
    for i in range(runs):
        steps, rewards = Qlearning(episodes, predatorLocations[:predators], epsGreedyPolicy,alpha_pred=0.5,alpha_prey=0.05)
...
pl.ylim(0,1)
pl.savefig("plots/easyratio321.png")
pl.close()
...
# Put a legend to the right of the current axis
ax.legend(labels,loc='center left', bbox_to_anchor=(1, 0.5))
pl.savefig("plots/easysteps321.png")
...
# Put a legend to the right of the current axis
ax.legend(labels,loc='center left', bbox_to_anchor=(1, 0.5))
pl.savefig("plots/easystepscatch321.png")
...
pl.savefig("plots/easystepscrash321.png")